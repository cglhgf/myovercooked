...
document.onkeyup=function(e){
	...
	//Player2按键
		case 37:
			throttle(game.player2Moving({x:-1,y:0}),200);
			break;
		case 38:
			throttle(game.player2Moving({x:0,y:-1}),200);
			break;
		case 39:
			throttle(game.player2Moving({x:1,y:0}),200);
			break;
	...
	//Player1按键
		case 65:
			throttle(game.player1Moving({x:-1,y:0}),200);
			break;
		case 87:
			throttle(game.player1Moving({x:0,y:-1}),200);
			break;
		case 68:
			throttle(game.player1Moving({x:1,y:0}),200);
			break;
